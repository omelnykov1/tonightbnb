...
class Spot extends React.Component {
  ...
  componentDidMount() {
    ...
    document.addEventListener('scroll', () => {
      ...
      if (belowPictures !== this.state.scrollFixedUp)this.setState({ scrollFixedUp: belowPictures });
    });

    document.addEventListener('scroll', () => {
      const topPictures = window.scrollY > (document.body.scrollHeight - window.innerHeight - 345);
      if (topPictures !== this.state.scrollFixedB) this.setState({ scrollFixedB: topPictures });
    });
  }
            ...
            <div className="spot-photos-container">
              <div className="spot-grid">
                <div className="spot-main-photo">
                  <img className="main-photo" src={photoUrls[0]} />
                </div>
                <div className="spot-side-photos">
                  <img className="photo-row1" src={photoUrls[1]} />
                  <img className="photo-row1" src={photoUrls[2]} />
                  <img className="photo-row2" src={photoUrls[3]} />
                  <img className="photo-row2" src={photoUrls[4]} />
                </div>
