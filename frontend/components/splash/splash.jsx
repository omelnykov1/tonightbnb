    ...
    <div className="splash">
      ...
      <div className="splash-experinces">
        <div className="splash-column">
          ...
          <div className="parent"><span className="bottom">Unplug or reconnect on a trip that's just a short drive away.</span></div>
        </div>
        <div className="splash-column">
          <img className="splash-exp-image" src={left} />
          <span className="top">Online Experiences</span>
          <div className="parent"><span className="bottom">Unique activities we can do together, led by a world of hosts.</span></div>
        </div>
        <div className="splash-column">
          <img className="splash-exp-image" src={middle} />
          <span className="top">Entire homes</span>
          <br/>
          <div className="parent"><span className="bottom">Comfortable private places, with room for friends or family.</span></div>
        </div>
        <div className="splash-column">
          <img className="splash-exp-image" src={right} />
          <span className="top">Monthly stays</span>
          <br/>
          <div className="parent"><span className="bottom">Make Tonightbnb your home, for stays of a month or longer.</span></div>
        </div>
      </div>
      ...
      <div className="grid-container">
        <div className="left-online">
          <div className="online-exp1">
            ...
            <div className="paren-text-container"><span className="under-online-exp">Learn to propagate with Baltimore's "Plant Doctor"</span></div>
          </div>
        </div>
        <div className="right-online">
          <div className="grid-top">
            <div className="grid-top1">
              <div className="online-exp">
                ...
                <div className="paren-text-container"><span className="under-online-exp">Stretch. Breathe. Relax. Youga class with friends.</span></div>
              </div>
            </div>
            <div className="grid-top2">
              <div className="online-exp">
                <img className="splash-online-image" src={musician} />
                <div className="paren-text-container"><span className="under-online-exp">Meditate to music with Janice from Amsterdam</span></div>
              </div>
            </div>
          </div>
          <div className="grid-bottom">
            <div id="peng" className="online-exp">
              ...
              <div className="paren-text-container"><span className="under-online-exp">Support African penguins by drawing with Jon</span></div>
            </div>
          </div>
         </div>
        </div>
        ...
        <div className="host-hero-bottom">
          <div className="splash-escape1">
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={scranton}/></div>
            ...
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={newport}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Newport</h5>
          ...
          <div className="splash-escape2">
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={hampton}/></div>
              <div className="splash-escape-item-bottom">
                <h5>East Hampton</h5>
            ...
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={ocean}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Ocean City</h5>
          ...
          <div className="splash-escape3">
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={woodstock}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Woodstock</h5>
            ...
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={saratoga}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Saratoga</h5>
          ...
          <div className="splash-escape4">
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={hudson}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Hudson</h5>
            ...
            <div className="splash-escape-item">
              <div className="splash-escape-item-top"><img src={atlantic}/></div>
              <div className="splash-escape-item-bottom">
                <h5>Atlantic City</h5>
